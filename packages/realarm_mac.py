...
def do_alarm():
    print("MAC SHOULD EDIT:/Library/Preferences/com.yamaha.VOCALOID6.system.plist")
    print("THE VOCALOID6 COULD REPLACE TO 3,4,5")
    print("set DATABASE:COMPID:TIME=TimeID")
    print("set Database:COMPID:Date=TimeID")
    print("NO COMPLETE")
    return
